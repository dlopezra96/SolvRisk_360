...
from modules.concentration_algorithms.new_methods import fast_with_multilocal

# --------- Config ---------
DATA_FOLDER   = "data"
REPORT_FOLDER = "tests\\results"
OUTPUT_CSV    = os.path.join(REPORT_FOLDER, "test_fast_with_multilocal_results.csv")
RADIUS_LIST   = [200]
...
def run_benchmark():
    ...
    print(f"🚀 Starting fast_with_multilocal benchmark...\n")
    ...
    for filename in datasets:
        ...
        for radius in RADIUS_LIST:
            for metric in DISTANCES:
                ...
                try:
                    print(f"🔎 fast_with_multilocal → {metric.upper()} | Radius {radius}m")
